...
```{r}
CS_low_new <- CS_low/100 - env_cost/100
```

**The welfare of low income consumer is negative due to having to bear the environmental cost. It is -$2460.94**
...
```{r}
MEC_51 <- (0.85/2204.62)*51 #1.97
MEC_75 <- (0.85/2204.62)*75 #2.89
...
for(i in MEC_vec){
  ...
  results <- c(i, peq_new, qeq_new, encost_new, CSlow_new, CShigh_new)
  
  values <- bind_rows(results)
}
```
