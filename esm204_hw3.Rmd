...
#environmental cost
env_cost <- 1.8 * max(MPC$demand)
```

The benefit to consumers is \$`r CS_agg/100`. The benefit to producers is \$`r PS_calc/100`. The environmental costunder the status quo is $`r env_cost/100`
