...
#plot
ggplot() +
  geom_line(agg_data, mapping = aes(x = Qagg, y = price, color = "a"), lty = "solid") +
  geom_line(l_pred, mapping = aes(x = demand, y = price, color = "b"), lty = "dashed") +
  geom_line(h_pred, mapping = aes(x = demand, y = price, color = "c"), lty = "dashed") +
  geom_line(supply, mapping = aes(x = demand, y = price, color = "d"), lty = "solid") +
  scale_color_manual(values = cal_palette("kelp1"), labels = expression("Aggregate", "Low income", "High income", "MPC")) +
  labs(x = "Quantity (kWh)",
       y = "Price (cents)",
       color = "Demand Curve") + 
  theme_minimal()
