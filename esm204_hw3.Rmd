...
ggplot() +
  ...
  geom_line(MPC, mapping = aes(x = demand, y = price, color = "d"), lty = "solid") +
  scale_color_manual(values = cal_palette("dudleya"), labels = expression("Aggregate", "Low income", "High income", "MPC")) +
  labs(x = "Quantity (kWh)",
       y = "Price (cents)",
       color = "Demand Curve") + 
  theme_minimal()
