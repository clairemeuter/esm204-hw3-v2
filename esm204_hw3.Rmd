...
#plot
ggplot() +
  geom_line(agg_data, mapping = aes(x = Qagg, y = price, color = "Aggregate"), lty = "solid") +
  geom_line(l_pred, mapping = aes(x = demand, y = price, color = "Low income"), lty = "dashed") +
  geom_line(h_pred, mapping = aes(x = demand, y = price, color = "High income"), lty = "dashed") +
  geom_line(MPC, mapping = aes(x = demand, y = price, color = "MPC"), lty = "dotdash") +
  geom_segment(aes(x = 0, y = 1.8, xend = 819713.75, yend = 1.8, color = "MEC"), lty = "solid") +
  geom_line(MPC, mapping = aes(x = demand, y = price + 1.8, color = "MSC"), lty = "solid") +
